...
namespace MVC.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Funcional,Senha,PermissaoId,PapelId,DataAdmissao,DataDemissao,Cpf,Nome,Sexo,DataNascimento,Email,Telefone,EnderecoId")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Funcional,Senha,PermissaoId,PapelId,DataAdmissao,DataDemissao,Cpf,Nome,Sexo,DataNascimento,Email,Telefone,EnderecoId")] Funcionario funcionario)
        {
